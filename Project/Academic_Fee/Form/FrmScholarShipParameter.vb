...
Public Class FrmScholarShipParameter
    ...
    Private Const Col1FeeHeadWiseTotalScholarShip As Byte = 12

    Dim mStrMasterType As String = Academic_ProjLib.ClsMain.MasterType_ScholarshipParameter
    Dim mStrModuleType As String = Academic_Objects.ClsConstant.Module_Academic_Fee
                ...
                For I = 0 To .Rows.Count - 1
                    If .Item(Col1GUID, I).Value = "" Then
                        If DGL1.Item(Col1Category, I).Value.ToString.Trim <> "" And _
                            DGL1.Item(Col1Programme, I).Value.ToString.Trim <> "" And _
                            Val(DGL1.Item(Col1ProgrammeYear, I).Value) > 0 Then
