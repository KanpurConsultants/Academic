...
Public Class FrmVehicleGateInOut
    ...
    Private Sub FIniMaster(Optional ByVal BytDel As Byte = 0, Optional ByVal BytRefresh As Byte = 1)
        mQry = "SELECT G.DocID AS SearchCode FROM GateInOut G WHERE  V_Type = '" & ClsMain.Temp_NCat.StoreGatePass & "' "
        Topctrl1.FIniForm(DTMaster, AgL.GCn, mQry, , , , , BytDel, BytRefresh)
    End Sub

    Sub Ini_List()
        Try
            mQry = "Select V_Type as Code, Description, NCat From Voucher_Type Where NCat = '" & ClsMain.Temp_NCat.StoreGatePass & "' "
            ...
            mQry = "Select Sg.SubCode As Code, Sg.Name As Name, City.CityName, " & _
                             ...
                             " Order By Name "
            TxtParty.AgHelpDataSet(6) = AgL.FillData(mQry, AgL.GCn)
            ...
            mQry = "SELECT H.DocID AS Code, H.Manual_RefNo AS [Open No], " & _
                   " H.VehicleNo AS [Vehicle No], H.Driver as [Driver Name], Sg.DispName AS [Party], " & _
    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            ...
            AgL.PubFindQry = " SELECT H.DocID  + '1' AS SearchCode, " & _
                                ...
                                " H.V_Date AS EntryDate, H.V_Time AS EntryTime, H.VehicleNo AS [Vehicle No],SG.DispName as [Party], " & _
                                " H.Driver, H.Remarks AS [Remark], " & _
                                ...
                                " H.Close_Date AS EntryDate, H.Close_Time AS EntryTime, H.VehicleNo AS [Vehicle No] ,SG.DispName as [Party], " & _
                                " H.Driver,  " & _
            ...
            If mSearchCode.Trim <> "" Then
                ...
                With DsTemp.Tables(0)
                    ...
                    If mBlnIsCloseRecord Then
                        ...
                        TxtCloseEntryBy.Text = AgL.XNull(.Rows(0)("Close_EntryBy"))
    ...
    Private Sub Control_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles _
        ...
        TxtParty.Validating, TxtVehicleNo.Validating, _
         TxtRemarks.Validating, TxtInOut.Validating, TxtOpenManualNo.Validating
        Dim DrTemp As DataRow() = Nothing
    ...
    Private Sub Control_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles _
        TxtV_Type.Enter, TxtParty.Enter, TxtVehicleNo.Enter, _
         TxtRemarks.Enter
