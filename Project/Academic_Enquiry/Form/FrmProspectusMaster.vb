    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            AgL.PubFindQry = "Select H.Code As SearchCode, H.DisplayName As [" & LblDisplayName.Text & "], " & _
                                ...
                                " S.ManualCode AS [Session], P.ManualCode AS [Programme], H.SaleRate,H.Site_Code " & _
                                " From  Store_Item H WITH (NoLock) " & _
                                " LEFT JOIN Enquiry_Prospectus Sh ON Sh.Code=H.Code " & _
                                " LEFT JOIN Sch_Session S ON S.Code=SH.Session " & _
                                " LEFT JOIN Sch_Programme P ON P.Code=SH.Programme " & _
