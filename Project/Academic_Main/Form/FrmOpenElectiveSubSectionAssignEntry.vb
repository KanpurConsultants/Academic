...
Public Class FrmOpenElectiveSubSectionAssignEntry
    ...
    Private Sub IniGrid()
        ...
        With AgCL
            ...
            .AddAgTextColumn(DGL1, "Dgl1AdmissionDocId", 180, 8, "Student", True, True, False)
    ...
    Private Sub FIniMaster(Optional ByVal BytDel As Byte = 0, Optional ByVal BytRefresh As Byte = 1)
        ...
        If AgL.PubMoveRecApplicable Then
            mCondStr = " Where 1=1 And " & AgL.PubSiteCondition("S.Site_Code", AgL.PubSiteCode) & " And S.IsOpenElectiveSection <> 0 "
        ...
        Try
            ...
            If mSearchCode <> "" Then
                ...
                If MsgBox("Are You Sure To Delete This Record?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, AgLibrary.ClsMain.PubMsgTitleInfo) = vbYes Then
                    ...
                    mQry = "Update Sch_ClassSectionOpenElectiveSemesterAdmission " & _
                            " SET ClassSectionSubSection = Null " & _
                            " WHERE IsNull(ClassSectionSubSection,'') = " & AgL.Chk_Text(TxtClassSectionSubSection.AgSelectedValue) & ""
    ...
    Private Sub Topctrl_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            ...
            AgL.PubFindQry = "Select S.Code As SearchCode, Max(S.ClassSectionSubSectionDesc) [Sub-Section], Max(S.ClassSectionDesc) AS [Class/Section], Count(A.ClassSectionSubSection) AS [Total Sub-Section Student] " & _
                                " FROM ViewSch_ClassSectionSubSection S " & _
                                " LEFT JOIN Sch_ClassSectionOpenElectiveSemesterAdmission A ON S.Code = A.ClassSectionSubSection  " & _
            ...
            If mSearchCode <> "" Then
                ...
                With DsTemp.Tables(0)
                    If .Rows.Count > 0 Then
                        ...
                        TxtClassSectionSubSection.AgSelectedValue = AgL.XNull(.Rows(0)("Code"))
                ...
                mQry = "Select Sa.*, V1.AdmissionID " & _
                        ...
                        " Where Sa.ClassSectionSubSection = '" & mSearchCode & "'"
                DsTemp = AgL.FillData(mQry, AgL.GCn)
    ...
    Private Sub Calculation()
        ...
        With DGL1
            For I = 0 To .Rows.Count - 1
                ...
                If .Item(Col1YesNo, I).Value Is Nothing Then .Item(Col1YesNo, I).Value = False '""
    ...
    Private Sub ProcFillStudent()
        ...
        Try
            ...
            bCondQry = "SELECT Sa.AdmissionDocId " & _
                        " FROM ViewSch_ClassSectionOpenElectiveSemesterAdmission Sa " & _
                        " Where Sa.ClassSection = " & AgL.Chk_Text(TxtClassSection.AgSelectedValue) & " And " & _
                        " Case When Sa.ClassSectionSubSectionCode Is Null Then " & AgL.Chk_Text(TxtClassSectionSubSection.AgSelectedValue) & " Else Sa.ClassSectionSubSectionCode End <> " & AgL.Chk_Text(TxtClassSectionSubSection.AgSelectedValue) & " "

            mQry = "SELECT V1.Code, V1.AdmissionDocId, V1.AdmissionID, Convert(Bit, " & IIf(AgL.StrCmp(TxtSelectAll.Text, "Yes"), 1, 0) & " ) AS YesNo " & _
                    " FROM ViewSch_ClassSectionOpenElectiveSemesterAdmission V1 " & _
                    " Where " & AgL.PubSiteCondition("V1.Site_Code", TxtSite_Code.AgSelectedValue) & " And " & _
                    " V1.ClassSection = " & AgL.Chk_Text(TxtClassSection.AgSelectedValue) & " And V1.AdmissionDocId NOT IN (" & bCondQry & ") " & _
                    " Order By V1.StudentName "
