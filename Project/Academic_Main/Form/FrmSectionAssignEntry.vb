...
Public Class FrmSectionAssignEntry
    ...
    Private Sub IniGrid()
        ...
        With AgCL
            ...
            .AddAgTextColumn(DGL1, "Dgl1AdmissionDocId", 400, 8, "Student", True, True, False)
    ...
    Private Sub FIniMaster(Optional ByVal BytDel As Byte = 0, Optional ByVal BytRefresh As Byte = 1)
        ...
        If AgL.PubMoveRecApplicable Then
            ...
            mQry = "Select S.Code As SearchCode " & _
                    " From Sch_ClassSectionSemester S " & _
                    " " & mCondStr & " "
        ...
        Try
            ...
            If mSearchCode <> "" Then
                ...
                If MsgBox("Are You Sure To Delete This Record?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, AgLibrary.ClsMain.PubMsgTitleInfo) = vbYes Then
                    ...
                    AgL.Dman_ExecuteNonQry("Delete From Sch_ClassSectionSemesterAdmission Where Code='" & mSearchCode & "'", AgL.GCn, AgL.ECmd)
                    AgL.Dman_ExecuteNonQry("Delete From Sch_ClassSectionSemester Where Code='" & mSearchCode & "'", AgL.GCn, AgL.ECmd)
    ...
    Private Sub Topctrl_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            ...
            AgL.PubFindQry = "Select CS.Code As SearchCode, S.Name AS [Site Name], V1.ClassSectionDesc, V1.SessionProgrammeDesc, V2.StreamYearSemesterDesc, Cs.TotalStudent  " & _
                            " From Sch_ClassSectionSemester CS " & _
    ...
    Private Sub Topctrl_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                mQry = "INSERT INTO Sch_ClassSectionSemester ( Code, ClassSection, StreamYearSemester, TotalStudent, Remark, " & _
            ...
            Else
                mQry = "UPDATE Sch_ClassSectionSemester SET " & _
            ...
            With DGL1
                ...
                For I = 0 To .Rows.Count - 1                   
                    If .Item(Col1AdmissionDocId, I).Value <> "" And .Item(Col1YesNo, I).Value.ToString.Trim = AgLibrary.ClsConstant.StrCheckedValue Then
                        ...
                        mQry = "INSERT INTO Sch_ClassSectionSemesterAdmission ( " & _
        ...
        Try
            ...
            If mSearchCode <> "" Then
                ...
                mQry = "Select Sa.*, V1.AdmissionID " & _
                        " From Sch_ClassSectionSemesterAdmission Sa " & _
    ...
    Private Function Data_Validation() As Boolean
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                mSearchCode = AgL.GetMaxId("Sch_ClassSectionSemester", "Code", AgL.GCn, AgL.PubDivCode, TxtSite_Code.AgSelectedValue, 8, True, True, , AgL.Gcn_ConnectionString)
            End If
    ...
    Private Sub ProcFillStudent()
        ...
        Dim I As Integer
        Dim bCondQry$ = "", bQryAdmissionPromotion$ = ""
        Try
            If Topctrl1.Mode = "Browse" Then Exit Sub
            ...
            bCondQry = "SELECT Sa.AdmissionDocId " & _
                        " FROM Sch_ClassSectionSemester S " & _
                        " LEFT JOIN Sch_ClassSectionSemesterAdmission Sa ON S.Code = Sa.Code " & _
                        " Where S.StreamYearSemester = " & AgL.Chk_Text(TxtStreamYearSemester.AgSelectedValue) & " " & _
                        " AND Sa.SectionLeftOnDate Is NULL " & _
                        " And " & IIf(AgL.StrCmp(Topctrl1.Mode, "Add"), " 1=1 ", " S.Code <> '" & mSearchCode & "' ") & " "
            ...
            mQry = "SELECT Vp.AdmissionDocId, V1.AdmissionID, Convert(Bit, " & IIf(AgL.StrCmp(TxtSelectAll.Text, "Yes"), 1, 0) & " ) AS YesNo " & _
                    ...
                    " And Vp.AdmissionDocId NOT IN (" & bCondQry & ") " & _
