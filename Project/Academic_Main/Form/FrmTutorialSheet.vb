...
Public Class FrmTutorialSheet
    Inherits TempTutorialAssignment

    Dim mQry$ = ""

    Protected Const Col1Question_Tutorial As String = "Question"
    ...
    Public Sub New(ByVal StrUserPermission, ByVal DTUP)
        ...
        Me.EntryNCatList = "" & AgL.Chk_Text(ClsMain.Temp_NCat.TutorialSheet) & ""
    End Sub

    Private Sub FrmTutorialSheet_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        With DGL1
            .Columns(Col1Question).HeaderText = Col1Question_Tutorial
        End With
    End Sub
...
#End Region
    ...
    Private Sub FrmTutorialSheet_BaseEvent_Form_PreLoad() Handles Me.BaseEvent_Form_PreLoad
        LblV_Type.Text = "Tutorial Type"
        LblV_Date.Text = "Tutorial Date"
        LblV_No.Text = "Tutorial No."
    End Sub

    Private Sub FrmTutorialSheet_BaseEvent_Topctrl_tbPrn(ByVal SearchCode As String) Handles Me.BaseEvent_Topctrl_tbPrn
    ...
    Private Sub PrintDocument(ByVal mDocId As String)
        ...
        Try
            ...
            RepName = "Academic_TutorialSheet" : RepTitle = AgL.PubReportTitle
