...
Public Class FrmElectiveSubjectAssign
    ...
    Protected Const Col1IsElectiveSubject As String = "Is Elective Subject"
    ...
    Dim _FormType As eFormType = eFormType.ElectiveSubjectAssign

    Public Enum eFormType
        ElectiveSubjectAssign
    End Enum
    ...
    Sub Ini_List()
        Try
            ...
            DGL1.AgHelpDataSet(Col1StudentName, 3) = TxtAdmissionDocId.AgHelpDataSet.Copy
            ...
            DGL1.AgHelpDataSet(Col1StreamYearSemesterDesc, 6) = TxtStreamyearSemester.AgHelpDataSet.Copy
            ...
            DGL1.AgHelpDataSet(Col1ClassSectionDesc) = TxtClassSection.AgHelpDataSet.Copy
            ...
            DGL1.AgHelpDataSet(Col1SubjectName) = TxtSubject.AgHelpDataSet.Copy
        ...
        Try
            ...
            With DGL1
                ...
                For bIntI = 0 To .Rows.Count - 1
                    If AgL.StrCmp(.Item(Col1Tick, bIntI).Value.ToString, AgLibrary.ClsConstant.StrCheckedValue) _
                        And .Item(Col1StudentName, bIntI).Value.ToString.Trim <> "" Then

                        If AgL.StrCmp(TxtAssignSubject.Text, "Yes") Then
                            mQry = "SELECT IsNull(Max(AdmSub.Sr),0) AS MaxId " & _
                                    " FROM Sch_AdmissionSubject AdmSub WITH (NoLock) " & _
                                    " WHERE AdmSub.DocId = " & AgL.Chk_Text(.AgSelectedValue(Col1StudentName, bIntI)) & ""
                            ...
                            mQry = "INSERT INTO Sch_AdmissionSubject ( DocId, Sr, SemesterSubject) " & _
                                    " VALUES ( " & _
                                    " " & AgL.Chk_Text(.AgSelectedValue(Col1StudentName, bIntI)) & ", " & _
                                    " " & bIntSr & ", " & _
                        ...
                        Else
                            mQry = "DELETE FROM Sch_AdmissionSubject " & _
                                    " WHERE DocId = " & AgL.Chk_Text(.AgSelectedValue(Col1StudentName, bIntI)) & " " & _
                                    " AND SemesterSubject = " & AgL.Chk_Text(.Item(Col1SemesterSubjectCode, bIntI).Value) & " "
                            AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)
    ...
    Private Sub Control_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles _
        TxtSubject.Enter, TxtStreamyearSemester.Enter, TxtClassSection.Enter, TxtAdmissionDocId.Enter
        Try
            Select Case sender.name
    ...
    Private Sub Control_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles _
        TxtSubject.Validating, TxtStreamyearSemester.Validating, TxtClassSection.Validating, TxtAdmissionDocId.Validating
    ...
    Private Sub BtnFillSubject_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFill.Click
        ...
        Try
            Select Case sender.name
                Case BtnFill.Name
                    If FormType = eFormType.ElectiveSubjectAssign Then
                        ...
                        If AgL.RequiredField(TxtAssignSubject, LblAssignSubject.Text) Then Exit Sub

                        TxtSubject.Enabled = False
                        TxtStreamyearSemester.Enabled = False
                        TxtClassSection.Enabled = False
                        TxtAdmissionDocId.Enabled = False
                        TxtAssignSubject.Enabled = False

                        Call ProcFillStudent_ElectiveSubject()
                    End If
            End Select
        Catch ex As Exception
            Exit Sub
    ...
    Private Sub ProcFillStudent_ElectiveSubject()
        ...
        Try
            ...
            bCondStr += " And A.LeavingDate IS NULL "
            bCondStr += " And vSemSub.Subject = " & AgL.Chk_Text(TxtSubject.AgSelectedValue) & " "
            bCondStr += " And vSemSub.StreamYearSemester = " & AgL.Chk_Text(TxtStreamyearSemester.AgSelectedValue) & " "


            If AgL.StrCmp(TxtAssignSubject.Text, "Yes") Then
                bCondStr += " AND AdmSub.DocId IS NULL "
            Else
                bCondStr += " AND AdmSub.DocId IS Not NULL "
            End If

            If TxtAdmissionDocId.Text.Trim <> "" Then
                bCondStr += " And vP.AdmissionDocId = " & AgL.Chk_Text(TxtAdmissionDocId.AgSelectedValue) & " "
            End If

            If TxtClassSection.Text.Trim <> "" Then
                bCondStr += " And Csa.ClassSection = " & AgL.Chk_Text(TxtClassSection.AgSelectedValue) & " "
            End If
            ...
            mQry = "SELECT vSemSub.*, A.DocId AS AdmissionDocId, A.Student As StudentCode, A.StudentDispName, A.StudentManualCode, " & _
                    " vP.FromStreamYearSemester, Csa.ClassSection As ClassSectionCode, " & _
                    ...
                    " "
            mQry += bCondStr & " Order By A.StudentName "
            ...
            With bDtTemp
                ...
                Else
                    For bIntI = 0 To .Rows.Count - 1
                        ...
                        DGL1.Item(Col1Tick, bIntI).Value = AgLibrary.ClsConstant.StrUnCheckedValue
                        DGL1.Item(Col1IsSubjectSelected, bIntI).Value = IIf(AgL.VNull(.Rows(bIntI)("IsSubjectSelected")), "Yes", "No")

                        DGL1.Item(Col1SemesterSubjectCode, bIntI).Value = AgL.XNull(.Rows(bIntI)("Code"))

                        DGL1.AgSelectedValue(Col1SubjectName, bIntI) = AgL.XNull(.Rows(bIntI)("Subject"))
                        DGL1.AgSelectedValue(Col1StudentName, bIntI) = AgL.XNull(.Rows(bIntI)("AdmissionDocId"))
                        DGL1.Item(Col1StudentCode, bIntI).Value = AgL.XNull(.Rows(bIntI)("StudentCode"))
                        DGL1.AgSelectedValue(Col1ClassSectionDesc, bIntI) = AgL.XNull(.Rows(bIntI)("ClassSectionCode"))
                        DGL1.AgSelectedValue(Col1StreamYearSemesterDesc, bIntI) = AgL.XNull(.Rows(bIntI)("StreamYearSemester"))
                        DGL1.Item(Col1ManualCode, bIntI).Value = AgL.XNull(.Rows(bIntI)("ManualCode"))
                        DGL1.Item(Col1PaperID, bIntI).Value = AgL.XNull(.Rows(bIntI)("PaperId"))
                        DGL1.Item(Col1MinCreditHours, bIntI).Value = Format(AgL.VNull(.Rows(bIntI)("MinCreditHours")), "0.00")
                        DGL1.Item(Col1IsElectiveSubject, bIntI).Value = IIf(AgL.VNull(.Rows(bIntI)("IsElectiveSubject")), "Yes", "No")
                    Next bIntI
                End If
            End With
