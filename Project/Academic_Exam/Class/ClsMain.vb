    ...
    Private Sub CreateView()
        ...
        Try
            mQry = "CREATE VIEW dbo.ViewExam_SemesterExam As " & _
                  ...
                  " Sem.SessionProgrammeCode, Sem.SessionManualCode, Sem.ProgrammeManualCode, Sem.StreamManualCode, Sem.StreamCode, Sem.SessionCode, Sem.ProgrammeCode, Sem.SessionProgrammeStreamYear, Sem.StreamYearSemesterDesc  " & _
                  " FROM Exam_SemesterExam E " & _
                  " LEFT JOIN Exam_ExamType Et ON E.ExamType = Et.Code  " & _
                  " LEFT JOIN ViewSch_StreamYearSemester Sem ON E.StreamYearSemester = Sem.Code  "
        ...
        Try
            ...
            mQry1 = " SELECT S.Name AS StudentName, S.DispName AS StudentDispName, S.ManualCode AS StudentManualCode, S.FatherName, S.MotherName, " & _
                    ...
                    " Et.Description As ExamTypeDesc, Et.ExamNature, E.Description As SemesterExamDesc,Sem.SessionProgrammeCode, " & _
                    " Sem.SessionManualCode, Sem.ProgrammeManualCode, Sem.StreamManualCode, Sem.StreamCode, " & _
                    " Sem.SessionCode, Sem.ProgrammeCode, Sem.SessionProgrammeStreamYear, Sem.StreamYearSemesterDesc, " & _
                    " Sub.Subject AS SubjectCode,  Sub.SubjectDesc, Sub.SubjectDisplayName ,  Sub.SubjectType, Sub.ManualCode AS SubjectManualCode, " & _
                    " E1.Exam_MaxMarks, E1.Exam_MinMarks, E1.Test_MaxMarks,  " & _
                    " E1.Test_MinMarks, E1.Assignment_MaxMarks, E1.Assignment_MinMarks,  " & _
                    " E1.Attendance_MaxMarks, E1.Attendance_MinMarks, E1.Total_MaxMarks, E1.Total_MinMarks,  " & _
                    ...
                    " LEFT JOIN ViewSch_StreamYearSemester Sem WITH (NoLock) ON Ea1.StreamYearSemester = Sem.Code " & _
