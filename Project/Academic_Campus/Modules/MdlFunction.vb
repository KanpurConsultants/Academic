...
Module MdlFunction
    ...
    Public Sub IniDtMess_Enviro()
        If AgL.IsTableExist("Mess_Enviro", AgL.GCn) Then
            DtMess_Enviro = AgL.FillData("SELECT E.* FROM Mess_Enviro E WHERE E.Site_Code ='" & AgL.PubSiteCode & "'", AgL.GCn).Tables(0)
        End If
    End Sub
    ...
    'Public Function FunGetReadConnection(Optional ByVal StrConnectionString As String = "") As SqlConnection
    '    Dim mQry$ = ""
    '    Dim GcnRead As SqlClient.SqlConnection = Nothing

    '    Try
    '        If StrConnectionString.Trim = "" Then
    '            StrConnectionString = AgL.Gcn_ConnectionString
    '        End If
