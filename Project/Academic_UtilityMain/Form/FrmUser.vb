Public Class FrmUser
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                mQry = "Insert Into UserMast (Code, USER_NAME, PASSWD, Description, Admin, ModuleList, UpLoadDate,IsActive,InActiveDate) Values(" & _
                        ...
                        " " & AgL.Chk_Text(mStrModuleList) & ", " & AgL.ConvertDate(mUploadDate) & "," & IIf(AgL.StrCmp(TxtIsActive.Text, "Yes"), 1, 0) & "," & AgL.ConvertDate(txtActiveDate.Text) & ") "
            ...
            Else
                mQry = "Update UserMast Set " & _
                        ...
                        " IsActive=" & IIf(AgL.StrCmp(TxtIsActive.Text, "Yes"), 1, 0) & ", " & _
                        " InActiveDate=" & AgL.ConvertDate(txtActiveDate.Text) & ", " & _
            ...
            If DTMaster.Rows.Count > 0 Then
                ...
                With DsTemp.Tables(0)
                    If .Rows.Count > 0 Then
                        ...
                        TxtIsActive.Text = IIf(AgL.VNull(.Rows(0)("IsActive")) = True, "Yes", "No")
                        txtActiveDate.Text = Format(AgL.XNull(.Rows(0)("InActiveDate")), AgLibrary.ClsConstant.DateFormat_ShortDate)
    ...
    Private Sub TxtIsActive_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtIsActive.TextChanged, txtActiveDate.TextChanged
        Try
            If TxtIsActive.Text = "Yes" Then
                txtActiveDate.Text = ""
            End If
        Catch ex As Exception
