...
Public Class FrmHostelMaster
    ...
    Private Sub FIniMaster(Optional ByVal BytDel As Byte = 0, Optional ByVal BytRefresh As Byte = 1)
        mQry = "Select Ht_Hostel.Code As SearchCode " & _
               " From Ht_Hostel  " & _
               " Where " & AgL.PubSiteCondition("Ht_Hostel.Site_Code", AgL.PubSiteCode) & ""
        ...
        Try
            ...
            If DTMaster.Rows.Count > 0 Then
                If MsgBox("Are You Sure To Delete This Record?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, AgLibrary.ClsMain.PubMsgTitleInfo) = vbYes Then
                    ...
                    AgL.Dman_ExecuteNonQry("Delete From Ht_Hostel  Where Code='" & mSearchCode & "'", AgL.GCn, AgL.ECmd)
    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            ...
            AgL.PubFindQry = " SELECT HH.Code, HH.Description, HH.ManualCode AS [Manual Code], HH.ContactPerson AS [Contact Person], " & _
                                " c.CityName AS City, HH.Pin, HH.Phone, HH.Mobile, HH.Fax, HH.Email " & _
                                " FROM Ht_Hostel HH " & _
                                " LEFT JOIN City c ON c.CityCode=hh.CityCode "
    ...
    Private Sub Topctrl1_tbPrn() Handles Topctrl1.tbPrn
        ...
        Try
            ...
            AgL.PubReportTitle = "Hostel List"
            ...
            strQry = "SELECT  h.ManualCode AS Hostel,h.Description,h.ContactPerson as [Contact Person],h.Add1,h.Add2,h.Add3,  " & _
                    " h.Phone, h.Mobile, C.CityName AS City " & _
                    " FROM dbo.Ht_Hostel h " & _
            ...
            mPrnHnd.ReportTitle = "Hostel List"
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                ...
                mQry = "INSERT INTO dbo.Ht_Hostel(Code,	Description, ManualCode, ContactPerson, " & _
                        "Add1, Add2, Add3, CityCode, Pin, Phone, Mobile, Fax, Email, Div_Code,	Site_Code,	PreparedBy,  " & _
                        "U_EntDt,	U_AE) " & _
                        "VALUES ( " & _
                        " '" & mSearchCode & "',	" & AgL.Chk_Text(TxtDescription.Text) & ",	" & AgL.Chk_Text(TxtManualCode.Text) & " ,	" & AgL.Chk_Text(TxtContactPerson.Text) & ",	" & AgL.Chk_Text(TxtAdd1.Text) & ", " & _
                        " " & AgL.Chk_Text(TxtAdd1.Text) & ",	" & AgL.Chk_Text(TxtAdd3.Text) & ",	" & _
                        " " & AgL.Chk_Text(TxtCity.AgSelectedValue) & ",	" & AgL.Chk_Text(TxtPin.Text) & ",	" & AgL.Chk_Text(TxtPhone.Text) & ", " & _
                        " " & AgL.Chk_Text(TxtMobile.Text) & ",	" & AgL.Chk_Text(TxtFax.Text) & ",	" & AgL.Chk_Text(TxtEmail.Text) & ",	 " & _
            ...
            Else
                ...
                mQry = "UPDATE dbo.Ht_Hostel SET " & _
    ...
    Private Function Data_Validation() As Boolean
        Try
            ...
            If AgL.RequiredField(TxtContactPerson) Then Exit Function
            If Not AgL.IsValid_EMailId(TxtEmail, "EMail ID") Then Exit Function

            If Topctrl1.Mode = "Add" Then
                AgL.ECmd = AgL.Dman_Execute("Select count(*) From Ht_Hostel Where ManualCode='" & TxtManualCode.Text & "' ", AgL.GCn)
                If AgL.ECmd.ExecuteScalar() > 0 Then MsgBox("Manual Code Already Exist!") : TxtManualCode.Focus() : Exit Function

                AgL.ECmd = AgL.Dman_Execute("Select count(*) From Ht_Hostel Where Description='" & TxtDescription.Text & "' ", AgL.GCn)
                If AgL.ECmd.ExecuteScalar() > 0 Then MsgBox("Description Already Exist!") : TxtDescription.Focus() : Exit Function



                mSearchCode = AgL.GetMaxId("Ht_Hostel", "Code", AgL.GCn, AgL.PubDivCode, AgL.PubSiteCode, 6, True, True, , AgL.Gcn_ConnectionString)
            Else
                AgL.ECmd = AgL.Dman_Execute("Select count(*) From Ht_Hostel Where ManualCode='" & TxtManualCode.Text & "' And Code<>'" & mSearchCode & "' ", AgL.GCn)
                If AgL.ECmd.ExecuteScalar() > 0 Then MsgBox("Manual Code Already Exist!") : TxtManualCode.Focus() : Exit Function

                AgL.ECmd = AgL.Dman_Execute("Select count(*) From Ht_Hostel Where Description='" & TxtDescription.Text & "' And Code<>'" & mSearchCode & "' ", AgL.GCn)
                If AgL.ECmd.ExecuteScalar() > 0 Then MsgBox("Description Already Exist!") : TxtDescription.Focus() : Exit Function
    ...
    Private Sub Control_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles _
        TxtManualCode.Enter, TxtDescription.Enter
        Try
