...
Public Class FrmFloorMaster
    ...
    Private Sub FIniMaster(Optional ByVal BytDel As Byte = 0, Optional ByVal BytRefresh As Byte = 1)
        mQry = "Select Ht_Floor.Code As SearchCode " & _
                " From Ht_Floor  "
        ...
        Try
            ...
            If DTMaster.Rows.Count > 0 Then
                If MsgBox("Are You Sure To Delete This Record?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, AgLibrary.ClsMain.PubMsgTitleInfo) = vbYes Then
                    ...
                    AgL.Dman_ExecuteNonQry("Delete From Ht_Floor  Where Code='" & mSearchCode & "'", AgL.GCn, AgL.ECmd)
    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            ...
            AgL.PubFindQry = "SELECT H.Code AS SearchCode,H.FloorNo AS [Floor No],H.Description AS [Description] FROM Ht_Floor H"

            AgL.PubFindQryOrdBy = "[Floor No]"
    ...
    Private Sub Topctrl1_tbPrn() Handles Topctrl1.tbPrn
        ...
        Try
            ...
            strQry = "SELECT h.FloorNo as [Floor No.], h.Description" & _
                    " FROM Ht_Floor h "
            ...
            mPrnHnd.ReportTitle = "Floor List"
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                ...
                mQry = " INSERT INTO Ht_Floor(Code,Description,FloorNo,Div_Code,Site_Code,PreparedBy, U_EntDt, U_AE) " & _
                         " VALUES ( " & _
                         " '" & mSearchCode & "',	" & AgL.Chk_Text(TxtDescription.Text) & ",	" & AgL.Chk_Text(TxtFloorNo.Text) & ",	" & _
            ...
            Else
                mQry = "UPDATE Ht_Floor   " & _
                        " SET  " & _
                         " Description = " & AgL.Chk_Text(TxtDescription.Text) & ", " & _
                         " FloorNo = " & AgL.Chk_Text(TxtFloorNo.Text) & ", " & _
    ...
    Private Function Data_Validation() As Boolean
        ...
        Try
            ...
            If AgL.RequiredField(TxtFloorNo, "Floor No") Then Exit Function
            If AgL.RequiredField(TxtDescription, "Description") Then Exit Function

            If Topctrl1.Mode = "Add" Then
 
                AgL.ECmd = AgL.Dman_Execute("Select count(*) From Ht_Floor Where Description='" & TxtDescription.Text & "' ", AgL.GCn)
                If AgL.ECmd.ExecuteScalar() > 0 Then MsgBox("Description Already Exist!") : TxtDescription.Focus() : Exit Function

                mSearchCode = AgL.GetMaxId("Ht_Floor", "Code", AgL.GCn, AgL.PubDivCode, AgL.PubSiteCode, 6, True, True, , AgL.Gcn_ConnectionString)

            Else
      
                AgL.ECmd = AgL.Dman_Execute("Select count(*) From Ht_Floor Where Description='" & TxtDescription.Text & "' And Code<>'" & mSearchCode & "' ", AgL.GCn)
                If AgL.ECmd.ExecuteScalar() > 0 Then MsgBox("Description Already Exist!") : TxtDescription.Focus() : Exit Function
            ...
            If DTMaster.Rows.Count > 0 Then
                ...
                With DsTemp.Tables(0)
                    If .Rows.Count > 0 Then
                        ...
                        TxtFloorNo.Text = AgL.XNull(.Rows(0)("FloorNo"))
                    End If
                End With
            Else
                BlankText()
    ...
    Private Sub Control_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles _
        TxtFloorNo.Enter, TxtDescription.Enter
        Try
    ...
    Private Sub Control_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles _
       TxtFloorNo.Validating, TxtDescription.Validating
        Try
            Select Case sender.NAME
