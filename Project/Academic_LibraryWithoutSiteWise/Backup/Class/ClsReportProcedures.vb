...
#End Region
    ...
    Private Sub ObjRepFormGlobal_ProcessReport() Handles ObjRFG.ProcessReport
        Select Case mGRepFormName
            ...
            Case QualityMasterReport, QualityMasterLogReport
                ProcQualityMasterReport()

            Case DesignMasterReport, DesignMasterLogReport
                ProcDesignMasterReport()

            Case YarnMasterReport, YarnMasterLogReport
                ProcYarnMasterReport()

            Case ShadeMasterReport, ShadeMasterLogReport
                ProcShadeMasterReport()

            Case YarnSkuMasterReport, YarnSkuMasterLogReport
                ProcYarnSkuMasterReport()

            Case SizeMasterReport, SizeMasterLogReport
                ProcSizeMasterReport()

            Case BuyerMasterLogReport, BuyerMasterReport
                ProcBuyerMasterReport()

            Case PortMasterReport, PortMasterLogReport
                ProcPortMasterReport()

            Case CityMasterLogReport, CityMasterReport
                ProcCityMasterReport()

            Case OtherMaterialLogReport, OtherMaterialMasterReport
    ...
    Private Sub ProcProdPlanReport()
        ...
        Try
            ...
            If AgL.StrCmp(mRepType, ClsMain.ReportType.Log) Then
                ...
                RepName = "RUG_ProductionPlanLogReport" : RepTitle = "Production Plan Log Report"
            Else
                bTableName = "ProdPlan" : bSecTableName = "ProdPlanDetail PP1 ON PP1.DocID =PP.DocID"
                RepName = "RUG_ProductionPlanReport" : RepTitle = "Production Plan Report"
            End If
            ...
            If AgL.StrCmp(mRepType, ClsMain.ReportType.Main) Then
                ...
                ElseIf ObjRFG.ParameterCmbo1_Value = "Yes" Then
                    mCondStr = mCondStr & "AND  isnull(PP.IsDeleted,0) =1 "
                Else
                    mCondStr = mCondStr
                End If
