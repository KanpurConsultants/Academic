...
#End Region
    ...
    Private Sub FrmEmployee_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        ...
        mQry = " SELECT DISTINCT Class AS Code, Class FROM Lib_Member WHERE Class IS NOT NULL"
        TxtClass.AgHelpDataSet(0) = AgL.FillData(mQry, AgL.GCn)

        mQry = " SELECT DISTINCT Session AS Code, Session FROM Lib_Member WHERE Session IS NOT NULL "
