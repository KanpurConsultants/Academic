...
#End Region
    ...
    Private Sub FrmWriteoffBooks_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        mQry = "SELECT Book_UID AS Code, Book_UID AS BookId, Book, Edition, IsNull(IsInStock,0) As IsInStock FROM Lib_AccessionDetail "
        ...
        mQry = " SELECT Distinct A.Edition AS Code, A.Edition AS Edition " & _
                " FROM Lib_AccessionDetail A Where A.Edition Is Not Null "
