...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.LblCTotalQtyMeasureText.Size = New System.Drawing.Size(106, 16)
        ...
        Me.LblCTotalQtyText.Size = New System.Drawing.Size(73, 16)
...
#End Region
    ...
    Protected Sub IniItemHelpList()
        Try
            If AgL.StrCmp(mJobReceiveFor, ClsMain.JobReceiveFor.JobOrder) Then
                Dgl1.AgHelpDataSet(Col1Item, 16) = HelpDataSet.ItemFromJobOrder
            Else
        ...
        Try
            ...
            Else
                If Dgl1.AgDataRow IsNot Nothing Then
                    ...
                    AgCalcGrid1.FCopyStructureLine(AgL.XNull(Dgl1.AgDataRow.Cells("JobOrderDocId").Value), Dgl1, mRow, AgL.XNull(Dgl1.AgDataRow.Cells("LineSr").Value))
                End If
            End If
        Catch ex As Exception
        ...
        With Dgl1
            For I = 0 To .Rows.Count - 1
                ...
                If JobReceiveFor = ClsMain.JobReceiveFor.JobOrder Then
                    DrTemp = Dgl1.AgHelpDataSet(Col1Item).Tables(0).Select("Code = '" & Dgl1.AgSelectedValue(Col1Item, I) & "' And JobOrderDocId = '" & Dgl1.AgSelectedValue(Col1JobOrderDocID, I) & "'")
                Else
    ...
    Private Sub TempJobReceive_BaseFunction_CreateHelpDataSet() Handles Me.BaseFunction_CreateHelpDataSet
        ...
        mQry = " SELECT I.Code AS Code, I.Description AS Item, H.ManualRefNo As JobOrderNo, " & _
                ...
                " L.Sr As LineSr, IsNull(H.JobWithMaterialYN,0) As JobWithMaterialYN " & _
        ...
        mQry = "SELECT I.Code, I.Description AS Item, H.ManualRefNo As JobIssueNo, " & _
                ...
                " IsNull(L.Qty,0) - IsNull(L.ReceiveQty,0)  AS BalanceQty,  " & _
                ...
                " IsNull(H.Status,'" & ClsMain.EntryStatus.Active & "') AS Status,  " & _
                " H.Div_Code, Vt.NCat, H.JobWorker, Null as ProdOrder, I.Rate, L.Sr as LineSr, 0 As JobWithMaterialYN   " & _
        ...
        mQry = " SELECT  H.Code, H.Description, H.Unit, H.ItemType, IsNull(H.IsDeleted,0) As IsDeleted, " & _
                " H.UpcCode, H.Bom, H.Status, '' AS JobIssueDocId, '' As JobOrderDocId, " & _
