...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.LblVehicleNo.Location = New System.Drawing.Point(464, 129)
        ...
        Me.LblPhone.Location = New System.Drawing.Point(180, 129)
        ...
        Me.TxtPersonToMeet.AgMasterHelp = True
        ...
        Me.TxtPersonToMeet.Location = New System.Drawing.Point(301, 148)
        ...
        Me.TxtPersonToMeet.TabIndex = 10
        '
        'TxtPerpose
        '
        ...
        Me.TxtPerpose.Location = New System.Drawing.Point(301, 168)
        ...
        Me.LblPurpose.Location = New System.Drawing.Point(180, 169)
        ...
        Me.LblPersonToMeetReq.Location = New System.Drawing.Point(285, 156)
        ...
        Me.BtnSaveGateOutEntry.TabIndex = 809
        ...
        Me.LblPersonToMeet.Location = New System.Drawing.Point(180, 149)
        ...
        Me.Label1.Location = New System.Drawing.Point(285, 176)
...
#End Region
    ...
    Private Sub FrmQuality1_BaseFunction_FIniMastLog(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMastLog
        ...
        mQry = "Select P.UID As SearchCode " & _
               " From Visitor_GateInOut_Log P " & _
               " Left Join Voucher_Type Vt On P.V_Type = Vt.V_Type  " & _
    ...
    Private Sub FrmProductionOrder_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        AgL.PubFindQry = " SELECT H.DocID AS SearchCode, H.V_Date AS [In_DATE], H.V_Time AS [In_TIME], H.V_No AS [Entry_No], " & _
                        " H.Manual_RefNo AS [Manual_No], H.VisitorName AS [Visitor_Name], H.Address, H.Phone, H.VehicleNo AS [Vehicle_No], H.Person_To_Meet AS [Person_To_Meet],  " & _
                        " H.Perpose, H.Out_EntryBy AS [OUT_Entry_By], H.Out_Date AS [OUT_Date], H.Out_Time AS [OUT_Time], H.EntryBy AS [Entry_By], H.EntryDate AS [Entry_Date],  " & _
                        " H.EntryType AS [Entry_Type], H.EntryStatus AS [Entry_Status], H.ApproveBy AS [Approve_By], H.ApproveDate AS [Approve_Date], H.MoveToLog AS [Move_To_Log],  " & _
                        " H.MoveToLogDate AS [Move_To_Log_Date], H.Status, " & _
                        " D.Div_Name AS Division,SM.Name AS [Site_Name] " & _
                        " FROM  Visitor_GateInOut H  " & _
    ...
    Private Sub FrmProductionOrder_BaseEvent_FindLog() Handles Me.BaseEvent_FindLog
        ...
        AgL.PubFindQry = " SELECT H.UID AS SearchCode, H.V_Date AS [In_DATE], H.V_Time AS [In_TIME], H.V_No AS [Entry_No], " & _
                " H.Manual_RefNo AS [Manual_No], H.VisitorName AS [Visitor_Name], H.Address, H.Phone, " & _
                " H.VehicleNo AS [Vehicle_No], H.Person_To_Meet AS [Person_To_Meet],  " & _
                " H.Perpose, H.Out_EntryBy AS [OUT_Entry_By], H.Out_Date AS [OUT_Date], H.Out_Time AS [OUT_Time], " & _
                " H.EntryBy AS [Entry_By], H.EntryDate AS [Entry_Date],  " & _
                " H.EntryType AS [Entry_Type], H.EntryStatus AS [Entry_Status], H.ApproveBy AS [Approve_By], " & _
                " H.ApproveDate AS [Approve_Date], H.MoveToLog AS [Move_To_Log],  " & _
                " H.MoveToLogDate AS [Move_To_Log_Date], H.Status, " & _
                " D.Div_Name AS Division,SM.Name AS [Site_Name] " & _
                " FROM  Visitor_GateInOut_Log H  " & _
                " LEFT JOIN Division D ON D.Div_Code=H.Div_Code  " & _
                " LEFT JOIN SiteMast SM ON SM.Code=H.Site_Code  " & _
                " LEFT JOIN Voucher_Type Vt ON H.V_Type = Vt.V_Type  " & _
                " Where 1=1 " & mCondStr
    ...
    Private Sub FrmProductionOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = " UPDATE Visitor_GateInOut_Log " & _
                " SET Manual_RefNo = " & AgL.Chk_Text(TxtManualNo.Text) & ", " & _
                " VisitorName = " & AgL.Chk_Text(TxtVisitorName.Text) & ", " & _
                " Address = " & AgL.Chk_Text(TxtAddress.Text) & ", " & _
                " Phone = " & AgL.Chk_Text(TxtPhone.Text) & ", " & _
                " VehicleNo = " & AgL.Chk_Text(TxtVehicleNo.Text) & ", " & _
                " Person_To_Meet = " & AgL.Chk_Text(TxtPersonToMeet.Text) & ", " & _
                " Perpose = " & AgL.Chk_Text(TxtPerpose.Text) & " " & _
    ...
    Private Sub TempGateInOut_BaseEvent_Topctrl_tbAdd() Handles Me.BaseEvent_Topctrl_tbAdd
        ...
        mQry = " SELECT ISNULL(Max(substring(Manual_RefNo,7,4)),0) + 1  FROM Visitor_GateInOut_Log " & _
    ...
    Private Sub ProcSaveOutDetail(ByVal SearchCode As String)
        mQry = " UPDATE Visitor_GateInOut_Log " & _
                " SET " & _
                " Out_Date = " & AgL.Chk_Text(TxtOutDate.Text) & ", " & _
                " Out_Time = " & AgL.Chk_Text(TxtOutTime.Text) & ", " & _
                " Out_EntryBy = " & AgL.Chk_Text(TxtOutEntryBy.Text) & " " & _
                " Where UID = '" & mSearchCode & "'"
