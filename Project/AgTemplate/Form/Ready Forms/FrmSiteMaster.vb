...
Public Class FrmSiteMaster
    ...
    Sub Ini_List()
        ...
        mQry = "Select CityCode As Code, CityName As Name From City " & _
            "  Order By CityName"
        TxtCity_Code.AgHelpDataSet = AgL.FillData(mQry, AgL.GCn)
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                mQry = "Insert Into SiteMast (Code, ManualCode, Name, HO_YN, Add1, Add2, Add3, City_Code, PinNo, Phone, Mobile, AcCode, CreditLimit, Active, " & _
                        " U_EntDt, U_Name, U_AE) Values(" & _
                        " '" & mSearchCode & "', " & AgL.Chk_Text(TxtManualCode.Text) & ", " & AgL.Chk_Text(TxtName.Text) & ", " & _
                        " '" & AgL.MidStr(TxtHO_YN.Text, 0, 1) & "', " & AgL.Chk_Text(TxtAdd1.Text) & "," & _
                        " " & AgL.Chk_Text(TxtAdd2.Text) & ", " & AgL.Chk_Text(TxtAdd3.Text) & "," & _
                        " " & AgL.Chk_Text(TxtCity_Code.AgSelectedValue) & ", " & AgL.Chk_Text(TxtPinNo.Text) & "," & _
                        " " & AgL.Chk_Text(TxtPhone.Text) & ", " & AgL.Chk_Text(TxtMobile.Text) & ", " & AgL.Chk_Text(TxtAcCode.AgSelectedValue) & ", " & Val(TxtCreditLimit.Text) & ", " & IIf(AgL.StrCmp(TxtActive.Text, "Yes"), 1, 0) & "," & _
                ...
                End If
            Else
                mQry = "Update SiteMast Set ManualCode=" & AgL.Chk_Text(TxtManualCode.Text) & ", Name = " & AgL.Chk_Text(TxtName.Text) & ", HO_YN = '" & AgL.MidStr(TxtHO_YN.Text, 0, 1) & "'," & _
                        " Add1 = " & AgL.Chk_Text(TxtAdd1.Text) & ", Add2 = " & AgL.Chk_Text(TxtAdd2.Text) & ", Add3 = " & AgL.Chk_Text(TxtAdd3.Text) & "," & _
                        " City_Code = " & AgL.Chk_Text(TxtCity_Code.AgSelectedValue) & ", PinNo = " & AgL.Chk_Text(TxtPinNo.Text) & "," & _
                ...
                If AgL.StrCmp(AgL.PubSiteCode, mSearchCode) Then
                    ...
                    AgL.PubSiteCity = TxtCity_Code.Text
    ...
    Public Sub MoveRec()
        ...
        Try
            ...
            If mSearchCode <> "" Then
                TxtSiteCode.AgSelectedValue = mSearchCode
                ...
                With DsTemp.Tables(0)
                    If .Rows.Count > 0 Then
                        ...
                        TxtCity_Code.AgSelectedValue = AgL.XNull(.Rows(0)("City_Code"))
    ...
    Private Sub DispText(Optional ByVal Enb As Boolean = False)
        ...
        If Topctrl1.Mode = "Edit" Then TxtSiteCode.Enabled = False
        ...
        If AgL.PubDtEnviro.Rows.Count > 0 Then
            If AgL.VNull(AgL.PubDtEnviro.Rows(0)("IsLinkWithFA")) = 0 Then
                LblAcCode.Visible = False : TxtAcCode.Visible = False
            End If
        End If
    End Sub
    ...
    Private Function Data_Validation() As Boolean
        Try
            If AgL.RequiredField(TxtSiteCode) Then Exit Function
            ...
            If AgL.StrCmp(TxtSiteCode.Text, AgLibrary.ClsConstant.SiteCode_Reserve) Then
            ...
            If Topctrl1.Mode = "Add" Then
                AgL.ECmd = AgL.Dman_Execute("Select count(*) From SiteMast Where Code='" & TxtSiteCode.Text & "' ", AgL.GCn)
                If AgL.ECmd.ExecuteScalar() > 0 Then MsgBox("Site Code Already Exist!") : TxtSiteCode.Focus() : Exit Function

                AgL.ECmd = AgL.Dman_Execute("Select count(*) From SiteMast Where Name='" & TxtName.Text & "' ", AgL.GCn)
                If AgL.ECmd.ExecuteScalar() > 0 Then MsgBox("Site Name Already Exist!") : TxtName.Focus() : Exit Function
                ...
                mSearchCode = TxtSiteCode.Text

                mEnviroId = AgL.GetMaxId("Enviro", "ID", AgL.GCn, AgL.PubDivCode, TxtSiteCode.Text, 2, True, True, , AgL.Gcn_ConnectionString)
            Else
                AgL.ECmd = AgL.Dman_Execute("Select count(*) From SiteMast Where Name='" & TxtName.Text & "' And Code<>'" & mSearchCode & "' ", AgL.GCn)
                If AgL.ECmd.ExecuteScalar() > 0 Then MsgBox("Site Name Already Exist!") : TxtName.Focus() : Exit Function
