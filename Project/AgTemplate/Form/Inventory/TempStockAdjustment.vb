Public Class TempStockAdjustment
    ...
    Private Sub FrmProductionOrder_BaseEvent_FindLog() Handles Me.BaseEvent_FindLog
        ...
        AgL.PubFindQry = " SELECT H.UID AS SearchCode, H.V_Date AS Date, H.V_No AS [Entry No], " & _
                " H.FromProcess AS [FROM Process], H.ToProcess AS [TO Process], H.TotalQty AS [Total Qty], H.TotalMeasure AS [Total Measure],  " & _
                " H.Amount, H.Addition, H.Deduction, H.NetAmount, H.Remarks,  H.EntryBy AS [Entry By], H.EntryDate AS [Entry Date], " & _
                " H.ApproveBy AS [Approve By], H.ApproveDate AS [Approve Date], " & _
                " H.ReferenceDocID AS [Reference No], H.OrderBy AS [ORDER By], " & _
    ...
    Private Sub FrmProductionOrder_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        AgL.PubFindQry = " SELECT H.DocID AS SearchCode, H.V_Date AS Date, H.V_No AS [Entry No], " & _
                        " H.FromProcess AS [FROM Process], H.ToProcess AS [TO Process], H.TotalQty AS [Total Qty], H.TotalMeasure AS [Total Measure],  " & _
                        " H.Amount, H.Addition, H.Deduction, H.NetAmount, H.Remarks,  H.EntryBy AS [Entry By], H.EntryDate AS [Entry Date], " & _
                        " H.ApproveBy AS [Approve By], H.ApproveDate AS [Approve Date], " & _
                        " H.ReferenceDocID AS [Reference No], H.OrderBy AS [ORDER By], " & _
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1Status, 100, 0, Col1Status, True, False, False)
    ...
    Private Sub FrmProductionOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = "UPDATE StockHead_Log " & _
                " SET " & _
                " Subcode = " & AgL.Chk_Text(TxtAcName.AgSelectedValue) & ", " & _
                " FromProcess = " & AgL.Chk_Text(TxtFromProcess.AgSelectedValue) & ", " & _
                " ToProcess = " & AgL.Chk_Text(TxtToProcess.AgSelectedValue) & ", " & _
                " TotalQty = " & Val(LblTotalQty.Text) & ", " & _
                " TotalMeasure = " & Val(LblTotalMeasure.Text) & ", " & _
                " Amount = " & Val(LblTotalAmount.Text) & ", " & _
                " " & mGodownField & " = " & AgL.Chk_Text(TxtGodown.AgSelectedValue) & ", " & _
            ...
            For I = 0 To Dgl1.RowCount - 1
                If Dgl1.Item(Col1Item, I).Value <> "" Then
                    ...
                    mQry = "INSERT INTO Stock_Log (UID, DocId, Sr, V_Type, V_Prefix, " & _
                            " V_Date, V_No, Div_Code, Site_Code, SubCode, " & _
                            " Item, Process, Godown, Qty_Rec, Unit, " & _
                            " MeasurePerPcs, Measure_Rec, MeasureUnit, Rate, Amount, Status, Cost) " & _
                            " VALUES (" & AgL.Chk_Text(mSearchCode) & ", " & AgL.Chk_Text(mInternalCode) & ", " & mSr & ", " & AgL.Chk_Text(TxtV_Type.AgSelectedValue) & ", " & AgL.Chk_Text(LblPrefix.Text) & ", " & _
                            " " & AgL.Chk_Text(TxtV_Date.Text) & ", " & Val(TxtV_No.Text) & "," & AgL.Chk_Text(TxtDivision.AgSelectedValue) & ", " & AgL.Chk_Text(TxtSite_Code.AgSelectedValue) & ",  " & AgL.Chk_Text(TxtAcName.AgSelectedValue) & ", " & _
                            " " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1Item, I)) & ", " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1FromProcess, I)) & "," & AgL.Chk_Text(TxtGodown.AgSelectedValue) & ", " & Val(Dgl1.Item(Col1Qty, I).Value) & ", " & AgL.Chk_Text(Dgl1.Item(Col1Unit, I).Value) & "," & _
                            " " & Val(Dgl1.Item(Col1MeasurePerPcs, I).Value) & ", " & Val(Dgl1.Item(Col1TotalMeasure, I).Value) & ", " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1MeasureUnit, I)) & ", " & Val(Dgl1.Item(Col1Rate, I).Value) & ",  " & Val(Dgl1.Item(Col1Amount, I).Value) & ", " & AgL.Chk_Text(Dgl1.Item(Col1Status, I).Value) & ", " & Val(Dgl1.Item(Col1Amount, I).Value) & " )"
            ...
            For I = 0 To Dgl1.RowCount - 1
                If Dgl1.Item(Col1Item, I).Value <> "" Then
                    ...
                    mQry = "INSERT INTO Stock_Log (UID, DocId, Sr, V_Type, V_Prefix, " & _
                            ...
                            " MeasurePerPcs, Measure_Iss, MeasureUnit, Rate, Amount, Status, Cost) " & _
                            " VALUES (" & AgL.Chk_Text(mSearchCode) & ", " & AgL.Chk_Text(mInternalCode) & ", " & mSr & ", " & AgL.Chk_Text(TxtV_Type.AgSelectedValue) & ", " & AgL.Chk_Text(LblPrefix.Text) & ", " & _
                            " " & AgL.Chk_Text(TxtV_Date.Text) & ", " & Val(TxtV_No.Text) & "," & AgL.Chk_Text(TxtDivision.AgSelectedValue) & ", " & AgL.Chk_Text(TxtSite_Code.AgSelectedValue) & ",  " & AgL.Chk_Text(TxtAcName.AgSelectedValue) & ", " & _
                            " " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1Item, I)) & ", " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1ToProcess, I)) & "," & AgL.Chk_Text(TxtGodown.AgSelectedValue) & ", " & Val(Dgl1.Item(Col1Qty, I).Value) & ", " & AgL.Chk_Text(Dgl1.Item(Col1Unit, I).Value) & "," & _
                            " " & Val(Dgl1.Item(Col1MeasurePerPcs, I).Value) & ", " & Val(Dgl1.Item(Col1TotalMeasure, I).Value) & ", " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1MeasureUnit, I)) & ", " & Val(Dgl1.Item(Col1Rate, I).Value) & ",  " & Val(Dgl1.Item(Col1Amount, I).Value) & ", " & AgL.Chk_Text(Dgl1.Item(Col1Status, I).Value) & ", " & Val(Dgl1.Item(Col1Amount, I).Value) & " )"
    ...
    Private Sub TempStockAdjustment_BaseFunction_Create() Handles Me.BaseFunction_CreateHelpDataSet
        mQry = "SELECT I.Code, I.Description, I.Unit, I.ItemType, I.ItemGroup, I.ItemCategory, I.SalesTaxPostingGroup, Measure, MeasureUnit , IsNull(I.IsDeleted ,0) AS IsDeleted, IsNull(I.Status,'" & AgTemplate.ClsMain.EntryStatus.Active & "') AS Status, I.Div_Code FROM Item I"
        ...
        mQry = "SELECT S.SubCode AS Code, S.Name, IsNull(S.IsDeleted ,0) AS IsDeleted, IsNull(S.Status,'" & AgTemplate.ClsMain.EntryStatus.Active & "') AS Status  FROM SubGroup S"
