Public Class TempStockTransferIssue
    ...
    Private Sub FrmProductionOrder_BaseEvent_FindLog() Handles Me.BaseEvent_FindLog
        ...
        AgL.PubFindQry = " SELECT H.UID AS SearchCode, H.V_Type AS [Adjustment Type], H.V_Prefix AS Prefix, H.V_Date AS Date, H.V_No AS [Entry No], " & _
                        " H.ManualRefNo, H.FromProcess AS [FROM Process], H.ToProcess AS [TO Process], H.TotalQty AS [Total Qty], H.TotalMeasure AS [Total Measure],  " & _
                        ...
                        " H.MoveToLogDate AS [Move To Log Date], H.Status, H.ReferenceDocID AS [Reference No], H.Structure, H.OrderBy AS [ORDER By], " & _
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.LblManualRefNo.Location = New System.Drawing.Point(144, 100)
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1LotNo, 70, 20, Col1LotNo, True, False, False)
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                ...
                mQry = "INSERT INTO Stock_Log (UID, DocId, Sr, V_Type, V_Prefix, " & _
                        ...
                        " Item, Process, Godown, Qty_Iss, Unit, LotNo, " & _
                ...
                mQry = "INSERT INTO StockProcess_Log (UID, DocId, Sr, V_Type, V_Prefix, " & _
                        " V_Date, V_No, Div_Code, Site_Code, " & _
                        " Item, Process, Qty_Rec, Unit, LotNo, " & _
                ...
                With DsTemp.Tables(0)
                    ...
                    If .Rows.Count > 0 Then
                        For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                            ...
                            Dgl1.Item(Col1CurrentStock, I).Value = ClsMain.FunRetStock(Dgl1.AgSelectedValue(Col1Item, I), mInternalCode, , , , , TxtV_Date.Text, Dgl1.Item(Col1LotNo, I).Value)
    ...
    Private Sub FrmProductionOrder_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        ...
        TxtFromGodown.AgHelpDataSet(4, TabControl1.Top + TP1.Top, TabControl1.Left + TP1.Left) = HelpDataSet.Godown
        TxtToGodown.AgHelpDataSet(4, TabControl1.Top + TP1.Top, TabControl1.Left + TP1.Left) = HelpDataSet.Godown
        ...
        Try
            ...
            Else
                If Dgl1.AgHelpDataSet(Col1Item) IsNot Nothing Then
                    ...
                    Dgl1.Item(Col1CurrentStock, mRow).Value = ClsMain.FunRetStock(Dgl1.AgSelectedValue(Col1Item, mRow), mInternalCode, , , , , TxtV_Date.Text, Dgl1.Item(Col1LotNo, mRow).Value)
                End If
            End If
        Catch ex As Exception
        ...
        With Dgl1
            For I = 0 To .Rows.Count - 1
                If .Item(Col1Item, I).Value <> "" Then
                    ...
                    'If ClsMain.FunRetStock(.AgSelectedValue(Col1Item, I), mInternalCode, , TxtFromGodown.AgSelectedValue, .AgSelectedValue(Col1Process, I), .Item(Col1Status, I).Value) < Val(.Item(Col1Qty, I).Value) Then
                    If Val(.Item(Col1CurrentStock, I).Value) < Val(.Item(Col1Qty, I).Value) Then
                        MsgBox("Qty of " & .Item(Col1Item, I).Value & " In  Lot No " & .Item(Col1LotNo, I).Value & " is less than " & Dgl1.Item(Col1Qty, I).Value & "")
                        .CurrentCell = .Item(Col1Qty, I) : Dgl1.Focus()
                        passed = False : Exit Sub
                    End If
                End If
    ...
    Private Function FCheckDuplicateRefNo() As Boolean
        ...
        If Topctrl1.Mode = "Add" Then
            mQry = " SELECT COUNT(*) FROM StockHead WHERE ManualRefNo = '" & TxtManualRefNo.Text & "'   " & _
    ...
    'Private Sub Dgl1_CellMouseLeave(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Dgl1.CellMouseLeave
    '    Try
