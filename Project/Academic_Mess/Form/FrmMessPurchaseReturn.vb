Public Class FrmMessPurchaseReturn
    ...
    Public Sub New(ByVal StrUserPermission, ByVal DTUP)
        ...
        Me.AglObj = AgL
        Me.EntryNCatList = "" & AgL.Chk_Text(ClsMain.Temp_NCat.MessPurchaseReturn) & ""
    End Sub
...
#End Region
    ...
    Private Sub FrmPurchaseReturn_BaseEvent_Topctrl_tbAdd() Handles Me.BaseEvent_Topctrl_tbAdd
