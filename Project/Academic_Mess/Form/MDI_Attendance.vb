Public Class MDI_Attendance
    ...
    Private Sub MnuReports_DropDownItemClicked(ByVal sender As Object, ByVal e As System.Windows.Forms.ToolStripItemClickedEventArgs)
        ...
        FrmObj = CFOpen.FOpen_Attendance(e.ClickedItem.Name, e.ClickedItem.Text, False)
    ...
    Private Sub MnuTransactions_DropDownItemClicked(ByVal sender As Object, ByVal e As System.Windows.Forms.ToolStripItemClickedEventArgs) Handles _
        ...
        FrmObj = CFOpen.FOpen_Attendance(e.ClickedItem.Name, e.ClickedItem.Text)
        If FrmObj IsNot Nothing Then
            FrmObj.MdiParent = Me
            FrmObj.Show()
            FrmObj = Nothing
