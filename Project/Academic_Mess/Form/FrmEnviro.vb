        ...
        Try
            ...
            If DTMaster.Rows.Count > 0 Then
                If MsgBox("Are You Sure To Delete This Record?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, AgLibrary.ClsMain.PubMsgTitleInfo) = vbYes Then
                    ...
                    AgL.Dman_ExecuteNonQry("Delete From Mess_Enviro Where Site_Code='" & mSearchCode & "'", AgL.GCn, AgL.ECmd)
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                mQry = " INSERT INTO Mess_Enviro	" & _
                        " (Site_Code, SalesTaxGroupItem, SalesTaxGroupParty, IsShiftAttendance, " & _
                        " AttendanceDbName, AttendanceServer, AttendanceUser, AttendancePassword,  " & _
                        ...
                        " " & IIf(AgL.StrCmp(TxtIsShift.Text, "Yes"), 1, 0) & ", " & _
            ...
            Else
                mQry = " UPDATE Mess_Enviro " & _
                        ...
                        " IsShiftAttendance = " & IIf(AgL.StrCmp(TxtIsShift.Text, "Yes"), 1, 0) & ", " & _
            ...
            If DTMaster.Rows.Count > 0 Then
                ...
                With DsTemp.Tables(0)
                    If .Rows.Count > 0 Then
                        ...
                        TxtIsShift.Text = IIf(AgL.VNull(.Rows(0)("IsShiftAttendance")), "Yes", "No")
